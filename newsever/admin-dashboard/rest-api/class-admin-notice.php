...
class AdminNotice
{
  ...
  function newsever_dashboard_notice_content()
  {
    ...
    $notice_starter_msg = sprintf(
      ...
      esc_html__('Let your imagination soar! Designed with User-Friendly features, incorporating the Latest Trends and SEO-Friendly Markups. We genuinely appreciate you choosing our theme!', 'newsever'),
      $newsever_templatespare_url,
